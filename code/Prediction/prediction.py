...
# Dự đoán khả năng bệnh nhân tái nhập viện trong vòng 30 ngày
# ============================================================
...
# Một bệnh nhân chỉ xuất hiện ở TRAIN hoặc TEST,
...
train_idx, test_idx = next(
    gss.split(X, y, groups=patient_id)
)
...
# Random Forest là model nâng cao hơn
# và có thể cung cấp Feature Importance.
